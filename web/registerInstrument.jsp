<%-- 
    Document   : registerInstrument
    Created on : 13 Nov 2023, 5:17:55 pm
    Author     : user
--%>
    ...
    <body>
        <div class="wrapper">
            <div class="inner">
                ...
                <form class="needs-validation" novalidate action="registerInstrument-process.jsp" method="post" onsubmit="return validateForm();">
                    <h3>Register New Instrument</h3>
                    <div class="form-holder">
                        <span><i class="bi bi-person-circle"></i></span>
                        <input type="text" name="instrumentname" id="instrumentname" class="form-control" placeholder="Instrument Name" required>
                    </div>
                    <button>
