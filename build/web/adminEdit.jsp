            ...
            <div class="row">
                ...
                <div class="col-md-7 border-right">
                    <div class="p-5 py-10">
                        ...
                        <form class="needs-validation" novalidate action="adminEdit-process.jsp" method="post">
                            <div class="row mt-3">
                                <div class="col-md-16">
                                    <label class="labels">User ID</label>
                                    <input type="text" name="userID" id="userID" value="<%=loggedInUser.getUserID()%>" readonly class="form-control" placeholder="User ID" value="">
                                </div>
                                <div class="col-md-16">
